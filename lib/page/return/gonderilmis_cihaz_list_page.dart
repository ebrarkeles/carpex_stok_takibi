...
//!api gelince düzenlenecek
  void navigateToDeviceListPage() {
    if (selectedDevice != null) {
      ...
      // print("Constants.iadeCihazListesi.contains(cihaz.cihazKodu) : ${Constants.iadeCihazListesi.contains(cihaz.cihazKodu)}");
  ...
  void continueAddDeviceList(deviceCode) {
    bool isDeviceExists = Constants.iadeCihazListesi.any((cihaz) => cihaz.cihazKodu == deviceCode);
              ...
              leading: IconButton(
                onPressed: () {
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (BuildContext context) => DeviceListPage(selectedCustomer: Constants.musteri)),
                            ...
                            child: newGonderilmisCihazlar.isEmpty
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      // print("item $item");
                                      if (selectedDevice != null && selectedDevice['value'].toString() == item['value'].toString()) {
                                        return Card(
