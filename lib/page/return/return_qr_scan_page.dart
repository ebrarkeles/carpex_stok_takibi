...
class ReturnQrScanPage extends StatefulWidget {
  const ReturnQrScanPage({super.key});
...
/*----------------------------------------------------------------------------*/
  ...
  void _addDeviceToCihazlar(String deviceCode) {
    ...
    bool isDeviceExists = Constants.iadeCihazListesi.any((e) => e.cihazKodu == crpDeviceId);
                                ...
                                controller: TextEditingController(
                                    text: scannedDevice.isNotEmpty
                                        ? !scannedDevice.startsWith("CRP-")
                                            ? scannedDevice = "CRP-${scannedDevice.toUpperCase().toString()}"
                                            : scannedDevice = scannedDevice.toUpperCase().toString()
                                        : ""),
                                readOnly: true,
                                autofocus: true,
